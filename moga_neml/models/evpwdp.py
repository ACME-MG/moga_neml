...
class Model(__Model__):
    ...
    def initialise(self):
        ...
        self.add_param("wd_0",   -1.0e1, 1.0e1)
        self.add_param("wd_1",   -1.0e1, 1.0e1)
        self.add_param("wd_2",   -1.0e1, 1.0e1)
        self.add_param("wd_3",   -1.0e1, 1.0e1)
    ...
    def calibrate_model(self, evp_s0, evp_R, evp_d, evp_n, evp_eta, wd_n, wd_0, wd_1, wd_2, wd_3):
        ...
        wd_wc         = interpolate.PolynomialInterpolate([wd_0, wd_1, wd_2, wd_3])

...
from neml import elasticity, surfaces, hardening, visco_flow, general_flow, models, ri_flow
...
class Model(__Model__):
    ...
    def calibrate_model(self, lih_s0, lih_k, c_gs1, c_gs2, c_cs1, c_cs2):
        ...
        * `...`: ...
        ...
        rilic_model    = models.SmallStrainRateIndependentPlasticity(elastic_model, plastic_flow)
        return rilic_model

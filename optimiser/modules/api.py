...
# Libraries
import time, sys
from modules.reader import get_exp_data
...
class API:
    ...
    def read_data(self, test_names, file=INPUT_FILE):
        self.prog.add(f"Reading in experimental data from {file}")
        self.test_names = test_names
        self.exp_curves = get_exp_data(test_names, INPUT_DIR, file)

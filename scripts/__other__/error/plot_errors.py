...
def get_error_value_list(error_dict:dict, info_list:list, opt:bool=True) -> list:
    ...
    error_name_list = [error_name] * len(error_value_list)
    return error_name_list, error_value_list
...
for i in range(len(PARAMS_STR[MODEL_INDEX]["opt"])):
    ...
    for j in range(len(error_dict_list)):
        ...
        error_name_list, error_value_list = get_error_value_list(error_dict_list[j], cal_oth_info_list, opt=False)
        plt.scatter(error_name_list, error_value_list, edgecolor="none", color="green", s=MARKER_SIZE**2, marker=MARKER_LIST[i], alpha=TRANSPARENCY)
        ...
        error_name_list, error_value_list = get_error_value_list(error_dict_list[j], val_oth_info_list, opt=False)
        plt.scatter(error_name_list, error_value_list, edgecolor="none", color="red", s=MARKER_SIZE**2, marker=MARKER_LIST[i], alpha=TRANSPARENCY)
        ...
        error_name_list, error_value_list = get_error_value_list(error_dict_list[j], cal_opt_info_list, opt=True)
        plt.scatter(error_name_list, error_value_list, edgecolor="black", color="green", linewidth=LINEWIDTH, s=MARKER_SIZE**2, marker=MARKER_LIST[i])
        ...
        error_name_list, error_value_list = get_error_value_list(error_dict_list[j], val_opt_info_list, opt=True)
        plt.scatter(error_name_list, error_value_list, edgecolor="black", color="red", linewidth=LINEWIDTH, s=MARKER_SIZE**2, marker=MARKER_LIST[i])
...
legend = plt.legend(handles=[cal, val], framealpha=1, edgecolor="black", fancybox=True, facecolor="white", fontsize=15, loc="upper left")
...
legend = plt.legend(handles=[t800, t900, t1000], framealpha=1, edgecolor="black", fancybox=True, facecolor="white", fontsize=15, loc="upper right")
plt.gca().add_artist(legend)

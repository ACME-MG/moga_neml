...
for directory_path in directory_paths:
    file_paths += [f"{directory_path}/{file}" for file in os.listdir(directory_path) if file.endswith(".csv")]
# file_paths = [
#     "../../data/creep/inl_1/AirBase_800_80_G25.csv",
#     "../../data/creep/inl_1/AirBase_800_70_G44.csv",
#     "../../data/creep/inl_1/AirBase_800_65_G33.csv",
#     "../../data/creep/inl_1/AirBase_800_60_G32.csv",
#     "../../data/tensile/inl/AirBase_800_D7.csv",
#     "../../data/creep/inl_1/AirBase_900_36_G22.csv",
#     "../../data/creep/inl_1/AirBase_900_31_G50.csv",
#     "../../data/creep/inl_1/AirBase_900_28_G45.csv",
#     "../../data/creep/inl_1/AirBase_900_26_G59.csv",
...
for file_path in file_paths:
    ...
    work_failure = math.log10(work_failure)
    ...
    avg_work_rate = math.log10(avg_work_rate)
    avg_work_rate_list.append(avg_work_rate)
    
    # Plot the results
    if curve["type"] == "creep":
        plt.scatter([avg_work_rate], [work_failure], color="red")
    if curve["type"] == "tensile":
        plt.scatter([avg_work_rate], [work_failure], color="blue")
...
# Save the plot
plt.xlabel("log_10(avg_work_rate)")
plt.ylabel("log_10(work_failure)")
plt.scatter([], [], color="red", label="Creep")
plt.scatter([], [], color="blue", label="Tensile")
